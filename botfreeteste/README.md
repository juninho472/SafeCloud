...
```apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/juninho472/SafeCloud/main/botfreeteste/iniciar.sh -O iniciar.sh; chmod +x iniciar.sh; ./iniciar.sh```
